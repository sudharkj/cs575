...
int main(int argc, char *argv[]) {
    ...
    printf("Iteration,Threads,Trials,Probability,MegaTrialsPSec,MaxPerformance\n");
    ...
    for (int t = 0; t < NUMTRIES; t++) {
        ...
        if (NUMTRIALS) currentProb = (float) numHits / (float) NUMTRIALS;
        else currentProb = 0.0;
        printf("%d,%d,%d,%.2lf,%.2lf,%.2lf\n", t+1, NUMT, NUMTRIALS, currentProb, megaTrialsPerSecond, maxPerformance);
    }
